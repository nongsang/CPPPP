...
namespace CPPPP
{
    class StopWatch
    {
        ...
        public static void Main()
        {
            ...
            Console.WriteLine("Frequency : " + Stopwatch.Frequency);            // 내 컴퓨터가 초당 몇 틱을 측정하는지 알려준다.
            ...
            Console.WriteLine("Total Ticks : " + st.ElapsedTicks / Stopwatch.Frequency);    // 그냥 st.ElapsedMilliseconds를 1000으로
                                                                                            // 나눠도 초를 표시할 수 있지만
                                                                                            // ElapsedTicks를 Frequency로 나눠도 된다.
        }
    }
}