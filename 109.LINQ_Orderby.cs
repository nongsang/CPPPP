    ...
    class LINQ_OrderBy
    {
        ...
        public static void Main()
        {
            ...
            var ageOver30 = from person in people           // person이란 레퍼런스로 people 집단 중에서 원소 하나씩 지정하는데
                            orderby person.Age ascending    // person이 가리키는 원소의 Age의 오름차순으로 정렬
                            orderby person.Age              // ascending이 없어도 자동 오름차순
                            //orderby person.Age descending // 내림차순으로 하고 싶으면 decending으로 바꾼다.
